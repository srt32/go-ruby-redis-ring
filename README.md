...
The hash ring implementation above routes keys to primary Redis nodes for both reads and writes. In production, you often want to distribute read traffic across multiple read replicas while keeping writes directed to primaries. Here's how to extend the Ruby-compatible ring to support this pattern.
